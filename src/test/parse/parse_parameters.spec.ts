...
describe("parseParameters()", () => {
    it("should parse an array of strings into a docstring struct", () => {
        ...
        const DocStringType = "type"

        const functionName = "function";

        const result = parseParameters(parameterTokens, body, functionName, DocStringType);
    ...
    it("should parse args with and without type hints", () => {
        ...
        const result = parseParameters(parameterTokens, [], "name", DocStringType);
    ...
    describe("parseReturns", () => {
        ...
        it("should parse return types wrapped in single quotes", () => {
            const DocStringType = "type";
            expect(
                parseParameters(["-> 'List[Type]'"], [], "name", DocStringType).returns).to.deep.equal({
                    type: "List[Type]",
            });
        });
    ...
    describe("parseYields", () => {
        it("should use the signature return type if it is an Iterator", () => {
            ...
            const parameterTokens = ["-> Iterator[int]"];
            const body: string[] = [];
            const result = parseParameters(parameterTokens, body, "name", DocStringType);
    ...
    it("should result in no yield if there is no yield type or yield in body", () => {
        const DocStringType = "type"
        const result = parseParameters([], [], "name", DocStringType);
    ...
    it("should parse the return from the body if there is no return type in the definition", () => {
        ...
        const body = ["return 3"];
        const result = parseParameters(parameterTokens, body, "", DocStringType);
    ...
    it("should parse simple exception", () => {
        ...
        const result = parseParameters([], functionContent, "", DocStringType);
